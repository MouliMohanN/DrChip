...
import com.drchip.android.views.custom.materialcalederview.format.ArrayWeekDayFormatter;
import com.drchip.android.views.custom.materialcalederview.format.DateFormatTitleFormatter;
import com.drchip.android.views.custom.materialcalederview.format.DayFormatter;
import com.drchip.android.views.custom.materialcalederview.format.MonthArrayTitleFormatter;
import com.drchip.android.views.custom.materialcalederview.format.TitleFormatter;
import com.drchip.android.views.custom.materialcalederview.format.WeekDayFormatter;
...
public class MaterialCalendarView extends ViewGroup {
    ...
    /**
     * Set a {@linkplain com.drchip.android.views.custom.materialcalederview.format.WeekDayFormatter}
     * with the provided week day labels
     *
     * @param weekDayLabels Labels to use for the days of the week
     * @see com.drchip.android.views.custom.materialcalederview.format.ArrayWeekDayFormatter
     *
     */
